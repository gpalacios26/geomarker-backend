...
public class ExcelGeneratorDispositivo {

	public static ByteArrayInputStream listadoToExcel(List<Dispositivo> dispositivos) throws IOException {
		String[] COLUMNs = { "ID", "Código", "Nombre", "Descripción", "Correo", "Token" };
		try (Workbook workbook = new XSSFWorkbook(); ByteArrayOutputStream out = new ByteArrayOutputStream();) {
            ...
            cell_Title.setCellValue("LISTADO DE DISPOSITIVOS");
			...
			for (Dispositivo datos : dispositivos) {
				...
				cell_5.setCellValue(datos.getCorreo());
				cell_5.setCellStyle(BodyCellStyle);
				
				Cell cell_6 = row.createCell(5);
				cell_6.setCellValue(datos.getToken());
